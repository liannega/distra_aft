...
import 'package:dsimcaf_1/data/api/models/auth_model.dart';
...
class AuthApi extends AuthRepository {
  ...
  Future<CustomResponse> clearAuthData() async {
    try {
      ...
      await prefs.remove(SharedPrefsKey.currentUserDataKey);
      await prefs.remove(SharedPrefsKey.currentUserIdkey);
      _dio.updateToken("");
  ...
  Future<CustomResponse<AuthResponse>> login(
    ...
    try {
      ...
      await prefs.setString(SharedPrefsKey.currentUserIdkey, authResponse.user.id.toString());
