...
class _ConfigurationPageState extends State<ConfigurationPage> {
            ...
            children: [
              ...
              _buildConfigCard([
                ...
                _buildConfigItem(
                  ...
                  title: 'Configurar conexión al API',
              ...
              _buildConfigCard([
                _buildConfigItem(
                  ...
                  subtitle: 'Ver historial de actualizaciones',
  ...
  void _handleUpdateDatabase() async {
    ...
    _showSuccessSnackBar('Base de datos actualizada correctamente');
  }
  ...
  void _handleConfigureAPI() async {
    ...
    _showInfoDialog(
      'Configurar API',
      'Esta función permite configurar la conexión al servidor API. Contacte al administrador para obtener las credenciales necesarias.',
    );
  }
            ...
            content: const SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 8),
                  Text('• Lanzamiento inicial de DISTRA AFT'),
                  Text('• Sistema de verificación de activos fijos'),
                  Text('• Gestión de responsables y áreas'),
          ...
          (context) => AlertDialog(
            ...
            content: const Column(
              ...
              children: [
                ...
                SizedBox(height: 16),
                Text('Versión: 1.0.0'),
                Text('Desarrollado por: XETID'),
                SizedBox(height: 16),
                Text(
                  'Aplicación para la gestión y verificación de activos fijos, útiles y herramientas.',
                  textAlign: TextAlign.center,
                ...
                const Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: 8),
                      Text(
                        'Invita a otros usuarios a usar esta aplicación',
                        textAlign: TextAlign.center,
                        style: TextStyle(color: Color(0xFF64748B)),
                      ),
                    ],
                  ...
                  child: Column(
                    children: [
                      ...
                      _buildShareOption(
                        ...
                        subtitle: 'Enviar invitación por correo',
                        onTap: () {
                          Navigator.pop(context);
                          _shareViaEmail();
                        },
  ...
  void _copyAppLink() {
    const appLink =
        'https://play.google.com/store/apps/details?id=com.distra.aft';
...
Descárgala aquí: https://play.google.com/store/apps/details?id=com.distra.aft
...
''';
  ...
  void _shareViaEmail() {
    const subject = 'Te invito a usar DISTRA AFT';
    const body = '''
Hola,

Te invito a probar DISTRA AFT, una excelente aplicación para la gestión y verificación de activos fijos.

Con esta app puedes:
• Verificar activos fijos de manera eficiente
• Gestionar responsables y áreas
...
''';
    ...
    Clipboard.setData(ClipboardData(text: emailData));
    _showSuccessSnackBar('Datos del email copiados. Abre tu cliente de correo');
  }
